export const ProjectCard = ({
  ...
  return (
    <div className="group relative mb-2 flex aspect-widescreen h-full w-full flex-col bg-neutral-900 p-10 dark:bg-white">
      ...
      <iframe
        ...
        allowFullScreen
        loading="lazy"
        className="pointer-events-none absolute top-1/2 left-1/2 z-0 h-[169%] min-h-full w-auto min-w-full max-w-none -translate-y-full -translate-x-1/2 transition-opacity duration-700"
      />
    </div>
  );
};
